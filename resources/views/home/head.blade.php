...
{{--<--single-->--}}
<link rel="stylesheet" href="{{asset('app/plugins/themify-icons/themify-icons.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/single_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/single_responsive.css')}}">
