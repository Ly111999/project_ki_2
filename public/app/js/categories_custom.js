            ...
            filterButton.on('click', function () {
                $('.product-grid').isotope({
                    filter: function () {
                        ...
                        var itemPrice = $(this).find('.product_price').clone().children().remove().end().text().replace('', 'vnd');
            ...
            $("#slider-range").slider(
                {
                    ...
                    step: 100000,
                    max: 3000000,
                    values: [$("#startPrice").val(), $("#endPrice").val()],
                    slide: function (event, ui) {
                        $("#amount").val(Number(ui.values[0]).format(0) + " - " + Number(ui.values[1]).format(0));
                        $('#startPrice').val(ui.values[0]);
                        $('#endPrice').val(ui.values[1]);
                    }
                });
            $("#amount").val(Number($("#slider-range").slider("values", 0)).format(0) + " - " + Number($("#slider-range").slider("values", 1)).format(0));
        });
    }
